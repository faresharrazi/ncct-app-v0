class GeneralIncome < ApplicationRecord
  ...
  # Callbacks for creating, updating, and destroying income
  ...
  # Allocate income to accounts and recalculate net income
  ...
  # Reallocate income difference to accounts and recalculate net income
  ...
  # Recalculate net income and redistribute balances on destroy
  ...
  # Distribute income or adjustments to accounts
